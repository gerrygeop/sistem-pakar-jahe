...
// $url = (isset($data['login']) && $data['login'] == 'admin') ? 'loginAdmin' : 'loginMahasiswa';
...
<div class="container">
    ...
    <div class="row">
        <div class="col-11 col-md-8 col-lg-6 mx-auto mt-5 px-3 px-md-5 bg-white shadow-sm border rounded">
            ...
            <?php $url = BASEURL . '\/auth/' . ((isset($data['login']) && $data['login'] == 'admin') ? 'loginAdmin' : 'loginMahasiswa'); ?>
            <form action="<?= $url; ?>" method="POST" class="pb-5 pt-3">
